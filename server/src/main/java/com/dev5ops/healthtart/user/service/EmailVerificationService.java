...
public class EmailVerificationService {
    ...
    @Autowired
    public EmailVerificationService(StringRedisTemplate stringRedisTemplate, JavaMailSender mailSender) {
    ...
    public void sendVerificationEmail(String email) {
        ...
        message.setTo(email);
        message.setSubject("Healthtart 이메일 인증 코드");
        message.setText("안녕하세요,\n\n"
                + "Healthtart를 이용해주셔서 감사합니다. 아래 인증 코드를 입력하여 이메일 인증을 완료해 주세요.\n\n"
